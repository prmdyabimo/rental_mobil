...
<div class="w-[100%]">
  <div class="w-[50%] mx-auto">
    <div class="flex flex-col mx-auto shadow-xl my-8">
      <form action="/Rental/saveDatapengembalian" method="post">
        ...
        <div class="w-[50%] mx-auto my-4">
          ...
          <input type="text" name="id_plat_mobil" id="id_plat_mobil" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  value="<?= $dr['id_plat_mobil']; ?>">
        </div>
        <div class="w-[50%] mx-auto my-4">
          <label for="tanggal_rental" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tanggal Rental</label>
          <input type="date" name="tanggal_rental" id="tanggal_rental" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  value="<?= $dr['tanggal_rental']; ?>">
        </div>
        <div class="w-[50%] mx-auto my-4">
          <label for="tanggal_kembali" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tanggal Kembali</label>
          <input type="date" name="tanggal_kembali" id="tanggal_kembali" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  value="<?= $dr['lama_sewa']; ?>">
        </div>

        <!-- USER -->
        <div class="w-[50%] mx-auto my-4">
          <label for="terlambat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Terlambat</label>
          <input type="number" name="terlambat" id="terlambat" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Keterlambatan">
        </div>
        <div class="w-[50%] mx-auto my-4">
          <label for="denda" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Denda</label>
          <input type="number" name="denda" id="denda" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  value="<?= $denda; ?>">
        </div>        
        <div class="flex my-4">
